...
<template>
    ...
    <div id="container-services">
        ...
        <div id="box-services">
            ...
            <div id="title" class="d-flex w-100">
                <h1>
                    Excellence in
                </h1>
                <div class="position-relative">
                    <span class="title-decor"> Services </span>
                    <div class="color-block"></div>
                </div>
            </div>

            <div id="p-and-button">
                <p>We are leaders in providing consultancy services with a set of cutting-edge technologies and
                    a team of
            ...
            <div class="d-flex align-items-center row" id="row-services">

                <div class="card col-12 col-md-5 col-lg-3">

                    <div class="icon-and-btn">
                        <i class="fa-solid fa-network-wired" style="font-size: 50px;"></i>
                        <a href="" style="font-size: 30px;" class="wrapper text-decoration-none">
                            <div class="pulse"><i class="fa-solid fa-arrow-right"></i></div>
                        </a>
                    </div>
...
.card:hover {
    ...
    @keyframes animate {
        0% {
            box-shadow: 0 0 0 0 #048282b7, 0 0 0 0;
        }

        50% {
            box-shadow: 0 0 0 20px rgb(255, 109, 74, 0), 0 0 0 0 #048282b7;
        }
